...
-   Get a list of GP practice details from the [ODS](https://www.odsdatasearchandexport.nhs.uk/) API using `get_gp_details.R`

-   Get monthly details of GP practice registered populations from [NHS Digital](https://digital.nhs.uk/data-and-information/publications/statistical/patients-registered-at-a-gp-practice) using `get_gp_registered_patients.R`

-   Process this data to extract out relevant details using `get_gp_population_summary.R`
...
-   Investigate the amount of missing data using `dpp_matching_variables_missingness.qmd`

-   Perform multiple imputation to 'fill-in' missing matching data using `dpp_impute_missing_matching_variables.qmd`
